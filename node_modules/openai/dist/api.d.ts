 ...
 */
import type { Configuration } from 'openai/dist/configuration';
import type { AxiosPromise, AxiosInstance, AxiosRequestConfig } from 'openai/node_modules/axios';
import type { RequestArgs } from 'openai/dist/base';
...
export declare class OpenAIApi extends BaseAPI {
     ...
     * @memberof OpenAIApi
     */
    createChatCompletion(createChatCompletionRequest: CreateChatCompletionRequest, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<CreateChatCompletionResponse, any>>;
    /**
     *
     * @summary Classifies the specified `query` using provided examples.  The endpoint first [searches](/docs/api-reference/searches) over the labeled examples to select the ones most relevant for the particular query. Then, the relevant examples are combined with the query to construct a prompt to produce the final label via the [completions](/docs/api-reference/completions) endpoint.  Labeled examples can be provided via an uploaded `file`, or explicitly listed in the request using the `examples` parameter for quick tests and small scale use cases.
     * @param {CreateClassificationRequest} createClassificationRequest
     ...
     * @memberof OpenAIApi
     */
    createImageEdit(image: File, prompt: string, mask?: File, n?: number, size?: string, responseFormat?: string, user?: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<ImagesResponse, any>>;
    /**
     *
     * @summary Creates a variation of a given image.
     * @param {File} image The image to use as the basis for the variation(s). Must be a valid PNG file, less than 4MB, and square.
     ...
     * @memberof OpenAIApi
     */
    createTranscription(file: File, model: string, prompt?: string, responseFormat?: string, temperature?: number, language?: string, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<CreateTranscriptionResponse, any>>;
    /**
     *
     * @summary Translates audio into into English.
     * @param {File} file The audio file to translate, in one of these formats: mp3, mp4, mpeg, mpga, m4a, wav, or webm.
     ...
     * @memberof OpenAIApi
     */
    createTranslation(file: File, model: string, prompt?: string, responseFormat?: string, temperature?: number, options?: AxiosRequestConfig): Promise<import("openai/node_modules/axios").AxiosResponse<CreateTranslationResponse, any>>;
    /**
     *
     * @summary Delete a file.
     * @param {string} fileId The ID of the file to use for this request
